...
import { UserIcon, MagnifyingGlassIcon, ChevronDownIcon, AdjustmentsVerticalIcon } from "react-native-heroicons/outline"
    ...
    return (
        <SafeAreaView className="bg-white pt-5">
            ...
            <ScrollView className="bg-gray-100" contentContainerStyle>
                ...
                <FeaturedRow id={1234} title="Tasty discounts" description="Paid placements from our partners" featuredCategory="featured"/>
                <FeaturedRow id={12345} title="Offers near you!" description="Paid placements from our partners" featuredCategory="featured"/>
            </ScrollView>
        </SafeAreaView>
    );
}
